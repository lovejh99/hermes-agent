...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("powerline", "Switch between native and powerline status bar (TUI)",
               "Configuration", cli_only=True, aliases=("pl",),
               args_hint="[native|powerline|toggle]", subcommands=("native", "powerline", "toggle")),
